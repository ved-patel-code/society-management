...
- [modules/onboarding.md](modules/onboarding.md) — ✅ designed. Society structure mapping (buildings/floors/houses or rows/houses), 3 numbering modes, blocking resumable wizard.
